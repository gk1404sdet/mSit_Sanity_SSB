...
public class AccountPage extends BasePage {
    ...
    // ---------- Locators ----------
    private final By account = By.xpath("//div[contains(text(), 'ACCOUNT')]");
    ...
    private final By addressType = By.xpath("(//button[@type='button'])[10]");
    ...
    private final By comElement = By.xpath("//div[@class='text-xs md:text-sm lg:text-base xl:text-lg font-medium text-neutral-900 select-none md:select-text']");
